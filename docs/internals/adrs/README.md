...
| [0011](0011-leave-desktop-app-sessions-untagged.md) | Leave desktop app sessions untagged rather than replace a file the app manages | Superseded by [0012](0012-tag-desktop-sessions-through-the-apps-env-vars.md) | 2026-09-08 |
| [0012](0012-tag-desktop-sessions-through-the-apps-env-vars.md) | Tag desktop app sessions through the app's own environment variables | Accepted | 2026-09-09 |
